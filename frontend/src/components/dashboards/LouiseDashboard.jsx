...
/**
 * Dashboard pour Louise (Assistante)
 *
 * Fonctionnalités:
 * - Voir inventaire de tous les techniciens
 * - Modifier les quantités de tous les techniciens
 * - Voir les tournées d'accords (lecture seule, pas de création)
 */
const LouiseDashboard = ({ currentUser }) => {
  ...
  const loadTournees = async () => {
    try {
      ...
      if (saved) {
        ...
        // Louise (assistante) voit toutes les tournées actives
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-900">Dashboard Louise</h1>
        <p className="text-gray-600">Assistante - Inventaire & tournées</p>
      </div>
...
export default LouiseDashboard
