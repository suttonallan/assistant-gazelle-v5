...
const InventaireDashboard = ({ currentUser }) => {
  ...
  // Charger les transactions - DÉSACTIVÉ pour éviter les erreurs HTML/JSON
  const loadTransactions = async () => {
    // Route backend non fonctionnelle - retourner tableau vide
    setTransactions([])
    return
    
    // CODE ORIGINAL DÉSACTIVÉ:
    // try {
    //   const url = `${API_URL}/inventaire/transactions?limit=50`
